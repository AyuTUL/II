...
int main()
{
	...
	c1.read();
	cout << endl
		 << "Enter details of Staff Coordinator :" << endl;
	c2.Staff::read();
	c2.read();
	cout << endl
		 << "Details of Teacher Coordinator :" << endl;
	c1.Teacher::display();
	c1.display();
	cout << endl
		 << "Details of Staff Coordinator :" << endl;
	c2.Staff::display();
	c2.display();
	return 0;
}